const CACHE_NAME = "bilancio-cache-v40";
const ASSETS = ["./", "./index.html", "./style.css?v=1.2.4", "./app.js?v=1.2.4", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
