const CACHE_NAME = "bilancio-cache-v9";
const ASSETS = ["./", "./index.html", "./style.css?v=1.0.9", "./app.js?v=1.0.9", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
