const CACHE_NAME = "bilancio-cache-v35";
const ASSETS = ["./", "./index.html", "./style.css?v=1.1.1", "./app.js?v=1.1.1", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
