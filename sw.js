const CACHE_NAME = "bilancio-cache-v22";
const ASSETS = ["./", "./index.html", "./style.css?v=1.0.22", "./app.js?v=1.0.22", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
