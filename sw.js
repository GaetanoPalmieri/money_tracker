const CACHE_NAME = "bilancio-cache-v18";
const ASSETS = ["./", "./index.html", "./style.css?v=1.0.18", "./app.js?v=1.0.18", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
