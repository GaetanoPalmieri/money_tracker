const CACHE_NAME = "bilancio-cache-v33";
const ASSETS = ["./", "./index.html", "./style.css?v=1.0.33", "./app.js?v=1.0.33", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
