const CACHE_NAME = "bilancio-cache-v37";
const ASSETS = ["./", "./index.html", "./style.css?v=1.2.0", "./app.js?v=1.2.0", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/apple-touch-icon.png"];
